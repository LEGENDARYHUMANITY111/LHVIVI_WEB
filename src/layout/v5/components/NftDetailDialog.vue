<template>
    <div>
        <Dialog :show="show" :title="title" @close="closeDialogClick" :close-on-click-modal="closeOnClickModal"
            ...
            <template #content>
                <div>
                    <div class="dialogTile">Genesis NFT</div>
                        ...
                        <template v-if="Object.keys(resp.nftDetail).length > 0">
                            ...
                            <div class="nftDetail">
                                <div class="nftTitleBox">
                                    ...
                                    <!-- <div class="postX" @click="toX(resp.nftDetail)">
                                        <div class="img">
            ...
            resp.nftDetail.mint_amount), 2) }} {{
                resp.nftDetail.price.unit[resp.nftDetail.pay_coin] }}
                                            ...
                                            <div class="discount" v-if="resp.nftDetail.price.orign[resp.nftDetail.pay_coin] != resp.nftDetail.price.pay[resp.nftDetail.pay_coin]">
            ...
            resp.nftDetail.mint_amount, 2) }} {{
                resp.nftDetail.price.unit[resp.nftDetail.pay_coin] }}
                                    ...
                                    <div class="item">
                                        <div class="itemTile">
                                            <span class="color2">●</span> Payment
                                        </div>
                                        <div>
                                    ...
                                    <div class="item">
                                        ...
                                        <div>
                                            <div class="discountVal">1 Sol≈ {{ resp.nftDetail.price.sol_usdt }} USDT
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
...
import { formatMoney, img, openWin } from '@/utils/utils';
const resp = reactive({
    nftDetail: {}
})
watch(
...
const getNftDetail = () => {
    getCollections({ id: prop.categoryId }).then((res) => {
...
const toX = (nftDetail) => {
    //openWin('https://twitter.com/intent/tweet?text=Hello%20world&url=' + encodeURI('https://dial.to/?action=solana-action%3Ahttps%3A%2F%2Fnft.test.51tb.vip%2Fapi%2Fsolana%2Factions%3Fhash%3D25&cluster=devnet'), '_blank');
}
...
.dialogTile {
    ...
    color: transparent;
    background-image: linear-gradient(90deg, #4100F9, #C300EF 50%);
    width: fit-content;
    margin: 0 auto;
...
.nftContent {
    ...
    .nftImage {
        ...
        // .bg {
        //     background-image: url('@/assets/v5/image/tmp1.jpg');
        //     position: absolute;
        //     top: 0;
        //     right: 0;
        //     left: 0;
